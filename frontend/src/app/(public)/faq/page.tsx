...
const faqs = [
  {
    id: 1,
    question: "What is ExpireEase?",
    answer: "ExpireEase is a platform designed for sharing self-destructing content like messages, files, or links. It allows you to set expiration rules based on time, view counts, or events, ensuring that your content is only accessible when needed."
  },
  {
    id: 2,
    question: "How do I get started with ExpireEase?",
  ...
  {
    id: 3,
    question: "Do I need an account to use ExpireEase?",
  ...
  },
  {
    ...
    answer: "You can share text messages, files, and links. ExpireEase supports a range of file types and ensures your content remains secure until it expires."
  },
  {
    id: 6,
  ...
  {
    id: 7,
    question: "Is my data secure with ExpireEase?",
  ...
  {
    id: 10,
    question: "Does ExpireEase support notifications for expiring content?",
  ...
  // {
  //   id: 12,
  //   question: "Is ExpireEase free to use?",
  ...
  // },
  {
    ...
    answer: "If you have any issues or questions, you can reach out to us through the contact form on our website or email us directly at support@expireease.com. We're here to help!"
  }
];
